...
Usage:
    funds_gather_moneydance_extension.py [options] PARAMFILE all
    funds_gather_moneydance_extension.py [options] PARAMFILE (%s)...
    funds_gather_moneydance_extension.py --conf=FILE
    funds_gather_moneydance_extension.py -h
...
.. automodule:: funds_gather_moneydance_extension
    :private-members:
"""

class FundsGatherExtension(object):
    """
    ...
    def go(self, argv):
        """ 
            The main entry point into FundsGatherExtension
